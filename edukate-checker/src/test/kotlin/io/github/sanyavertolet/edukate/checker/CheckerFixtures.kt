...
object CheckerFixtures {
    ...
    ) = SubmissionContext(submissionId, problemId, problemText, problemImageRawKeys, submissionImageRawKeys)
    ...
    fun checkResultMessage(
        ...
        errorType: CheckErrorType = CheckErrorType.NONE,
        explanation: String = "Correct.",
    ) = CheckResultMessage(submissionId, status, trustLevel, errorType, explanation)
