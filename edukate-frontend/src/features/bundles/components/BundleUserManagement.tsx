...
import { useBundleChangeUserRoleMutation, useBundleUserListQuery } from "@/features/bundles/api";
...
interface BundleUserManagementProps {
    shareCode: string;
}

export const BundleUserManagement: FC<BundleUserManagementProps> = ({ shareCode }) => {
    return (
