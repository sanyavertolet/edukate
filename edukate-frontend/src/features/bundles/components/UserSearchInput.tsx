...
import { useBundleInviteUserMutation } from "@/features/bundles/api";
...
export const UserSearchInput: FC<UserSearchInputProps> = ({ bundleShareCode, onInvited }) => {
    ...
    const onAddClick = () => {
        ...
        inviteUserMutation.mutate(
            { username: normalized, shareCode: bundleShareCode },
            {
                onSuccess: () => {
