...
import { CheckedNotification } from "@/features/notifications/types";
import { formatDate } from "@/shared/utils/date";

interface CheckedNotificationProps {
    notification: CheckedNotification;
}

export const CheckedNotificationComponent: FC<CheckedNotificationProps> = ({ notification }) => {
    return (
