...
describe("InvitationDialog", () => {
    ...
    it("opens with the bundle name in the title when bundleInfo is provided", () => {
        render(<InvitationDialog bundleInfo={{ bundleName: "Math Basics", inviterName: "Alice" }} onClose={vi.fn()} />);
    ...
    it("shows inviter name and bundle name in the description", () => {
        render(<InvitationDialog bundleInfo={{ bundleName: "Physics 101", inviterName: "Bob" }} onClose={vi.fn()} />);
    ...
    it("calls onClose(undefined) when Close is clicked", async () => {
        const onClose = vi.fn();
        render(<InvitationDialog bundleInfo={{ bundleName: "Math", inviterName: "Alice" }} onClose={onClose} />);
